...
public class Logger {
	...
	/**
	 * Constructor is Design pattern SINGLETON 
	 * and necessarily PRIVATE
	 */
	private Logger(String CurDir) {
		//System.out.println("Logger CurDir: "+nameFile);
		nameFile=CurDir+"//src//log//LogFile.txt";
		//System.out.println("Logger nameFile: "+nameFile);
	} 		
