...
/**
 * КЛАСС  ХОЛОДИЛЬНИК 3-го УРОВНЯ  
 * дополнение к классу ОБОРУДОВАНИЕ и КУХНЯ
 * от него будут создаваться конкретные объекты т.е. ХОЛОДИЛЬНИКИ
 */

public class Refrigerator extends Kitchen {	
	protected String type="Холодильник";
	...
	public Refrigerator () {
		super();
		power=GetRandomItem(500, 700); //Минимально-300 ватт, Максимально-1200 ватт.
