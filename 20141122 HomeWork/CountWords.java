...
public class CountWords {
	...
	/**
	 * Процедура проверки это символ препинания пробел и любой другой заявленный в symbols  
	 */
	...
	public static void main(String[] args) {
		...
		for (int i=0; i <= len; i++) {
			...
			} else if (len == i) { //Если последний символ в строке буква
				iterator++; System.out.println(iterator+".  "+str.substring(i-count, i+1));				
			} else count++; //Если буква считаем кол-во символов
		}		
