/*	
 * 	ЗАДАНИЕ № 24  		VacuumCleaner 	использует: Household
 * 	27.11.2014
 * 	
...
/**
 * КЛАСС  ПЫЛЕСОС 3-го УРОВНЯ  
 * дополнение к классу ОБОРУДОВАНИЕ и БЫТОВЫЕ
 * от него будут создаваться конкретные объекты т.е. ПЫЛЕСОСЫ
 */

public class VacuumCleaner extends Household {	
	protected String type="Пылесос  ";
	 ...
	 */	
	public VacuumCleaner (int Power, String Producer) {
